...
namespace max11603eee
{
   ...
   uint8_t read_adc(hph::ft260_interface &ft260s, uint8_t device_handle, uint8_t channel_number)
   {
      ...
      uint8_t result_value = ft260s.get_data_at_offset(device_handle, 0);
      printf("adc result value %u is %f\n",
             result_value,
             get_max11603eee_volts_per_bit(max11603eee::default_max11603eee_voltage_reference));
